...
var _galeryItems = require("./galery-items");
var _refs = require("./js/refs");
var _renderFunctions = require("./js/render-functions");
var _handlers = require("./js/handlers");
console.log((0, _galeryItems.galleryItems));
(0, _renderFunctions.renderGalleryMarkup)((0, _galeryItems.galleryItems));
...
function createGalleryMarkup(items) {
    return items.map(({ preview , original , description ,  })=>`<li class="gallery__item"><a href="${original}}"><img src="${preview}" alt="${description}"></a></li>
    `).join("");
}
...
parcelHelpers.export(exports, "onCloseModalBtnClick", ()=>onCloseModalBtnClick);
...
var _refs = require("./refs");
function openModal() {
    (0, _refs.refs).backdrop.classList.remove("is-hidden");
}
function closeModal() {
    (0, _refs.refs).backdrop.classList.add("is-hidden");
}

},{"./refs":"2WoF2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["1RB6v","8lqZg"], "8lqZg", "parcelRequired7c6")
